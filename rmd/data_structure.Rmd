...
get subcanopy diameter data into proper format for the fortedata package. Most important here, is the 1) Use of the 'googledrive' package to move smoothly from R to google drive, and 2) some examples of using base R for reformatting (Who ever uses base R!?)
