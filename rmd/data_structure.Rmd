...
## Data Workflow: Field data to fortedata format
...
1. Use google "Back Up and Sync" to backup your local data folder to google drive 
  ...
  + A couple things to note: 1) You can find this backed-up folder in the "Computers", "My Lapbtop"
...
3. Ideally all data products are properly formatted and structured from the start of 
